...
public class HMathTest {
    ...
    public void ClampToFloat_Double_WhenValueWithinRange_ReturnsValue(double value, float expected) {
        var result = HMath.ClampToFloat(value);
    ...
    public void ClampToFloat_Double_WhenValueBelowMin_ReturnsMin(double value, float min, float max, float expected) {
        var result = HMath.ClampToFloat(value, min, max);
        result.ShouldBe(expected);
    }
    ...
    [InlineData(1000.0, -100f, 100f, 100f)]
    [InlineData(150.5, -100f, 100f, 100f)]
    public void ClampToFloat_Double_WhenValueAboveMax_ReturnsMax(double value, float min, float max, float expected) {
        var result = HMath.ClampToFloat(value, min, max);
        result.ShouldBe(expected);
    }
    ...
    public void ClampToFloat_Double_WhenValueEqualsMin_ReturnsMin(double value, float min, float max, float expected) {
        var result = HMath.ClampToFloat(value, min, max);
        result.ShouldBe(expected);
    }
    ...
    public void ClampToFloat_Double_WhenValueEqualsMax_ReturnsMax(double value, float min, float max, float expected) {
        var result = HMath.ClampToFloat(value, min, max);
        result.ShouldBe(expected);
    }
    ...
    public void Map_Int_MapsCorrectly(int value, int fromSource, int toSource, int fromTarget, int toTarget, int expected) {
        var result = HMath.Map(value, fromSource, toSource, fromTarget, toTarget);
        result.ShouldBe(expected);
    }

    [Fact]
    public void Map_Int_WhenSourceRangeIsZero_ReturnsTargetMin() {
        var result = HMath.Map(50, 100, 100, 0, 10);
        result.ShouldBe(0);
    }
    ...
    public void Map_Float_WhenSourceRangeIsZero_ReturnsTargetMin() {
        var result = HMath.Map(50f, 100f, 100f, 0f, 10f);
        result.ShouldBe(0f);
    }
    ...
    public void Map_Double_WhenSourceRangeIsZero_ReturnsTargetMin() {
        var result = HMath.Map(50.0, 100.0, 100.0, 0.0, 10.0);
        result.ShouldBe(0.0);
    }
}
