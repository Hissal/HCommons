...
public static class OperationResult1ExtensionsAsync {
    ...
    [Pure]
    public static async Task<TResult> MatchAsync<TValue, TResult>(this OperationResult<TValue> result, Func<TValue, Task<TResult>> onSuccessAsync, Func<Error, Task<TResult>> onFailureAsync, Func<Cancelled, TResult> onCancelled)
    {
    ...
    [Pure]
    public static async Task<TResult> MatchAsync<TValue, TResult>(this OperationResult<TValue> result, Func<TValue, Task<TResult>> onSuccessAsync, Func<Error, TResult> onFailure, Func<Cancelled, Task<TResult>> onCancelledAsync)
    {
        if (result.IsSuccess) return await onSuccessAsync(result.Value!);
    ...
    [Pure]
    public static async Task<TResult> MatchAsync<TValue, TResult>(this OperationResult<TValue> result, Func<TValue, TResult> onSuccess, Func<Error, Task<TResult>> onFailureAsync, Func<Cancelled, Task<TResult>> onCancelledAsync)
    {
    ...
    [Pure]
    public static async Task<TResult> MatchAsync<TValue, TResult>(this Task<OperationResult<TValue>> resultTask, Func<TValue, Task<TResult>> onSuccessAsync, Func<Error, TResult> onFailure, Func<Cancelled, TResult> onCancelled)
    {
        return await (await resultTask).MatchAsync(onSuccessAsync, onFailure, onCancelled);
    }

    [Pure]
    public static async Task<TResult> MatchAsync<TValue, TResult>(this Task<OperationResult<TValue>> resultTask, Func<TValue, TResult> onSuccess, Func<Error, Task<TResult>> onFailureAsync, Func<Cancelled, TResult> onCancelled)
    {
        return await (await resultTask).MatchAsync(onSuccess, onFailureAsync, onCancelled);
    }

    [Pure]
    public static async Task<TResult> MatchAsync<TValue, TResult>(this Task<OperationResult<TValue>> resultTask, Func<TValue, TResult> onSuccess, Func<Error, TResult> onFailure, Func<Cancelled, Task<TResult>> onCancelledAsync)
    {
        return await (await resultTask).MatchAsync(onSuccess, onFailure, onCancelledAsync);
    }

    [Pure]
    public static async Task<TResult> MatchAsync<TValue, TResult>(this Task<OperationResult<TValue>> resultTask, Func<TValue, Task<TResult>> onSuccessAsync, Func<Error, Task<TResult>> onFailureAsync, Func<Cancelled, TResult> onCancelled)
    {
        return await (await resultTask).MatchAsync(onSuccessAsync, onFailureAsync, onCancelled);
    }

    [Pure]
    public static async Task<TResult> MatchAsync<TValue, TResult>(this Task<OperationResult<TValue>> resultTask, Func<TValue, Task<TResult>> onSuccessAsync, Func<Error, TResult> onFailure, Func<Cancelled, Task<TResult>> onCancelledAsync)
    {
        return await (await resultTask).MatchAsync(onSuccessAsync, onFailure, onCancelledAsync);
    }

    [Pure]
    public static async Task<TResult> MatchAsync<TValue, TResult>(this Task<OperationResult<TValue>> resultTask, Func<TValue, TResult> onSuccess, Func<Error, Task<TResult>> onFailureAsync, Func<Cancelled, Task<TResult>> onCancelledAsync)
    {
